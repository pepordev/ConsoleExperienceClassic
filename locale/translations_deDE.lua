...
ConsoleExperience_translation["deDE"] = {
    ...
    ["Configure experience and reputation bars. Bars appear below chat and fade out after timeout."] = "Konfiguriere Erfahrungs- und Rufleisten. Die Leisten erscheinen unter dem Chat und verschwinden nach Timeout.",
    ...
    ["CE Cursor"] = "Cursor",
    ["Cursor Up"] = "Cursor Auf",
    ["Cursor Down"] = "Cursor Ab",
    ["Cursor Left"] = "Cursor Links",
    ["Cursor Right"] = "Cursor Rechts",
    ["Cursor Click"] = "Cursor Klick",
    ["Cursor Right-Click"] = "Cursor Rechtsklick",
    ["Cursor Pickup"] = "Cursor Aufheben",
    ["Cursor Bind"] = "Cursor Binden",
    ["Cursor Delete"] = "Cursor Löschen",
    ["Cursor Unequip"] = "Cursor Ausrüsten",
    ["Cursor Close"] = "Cursor Schließen",

    -- Radial menu header and binding name
    ["CE Radial Menu"] = "Radialmenü",
    ["Toggle Radial Menu"] = "Radialmenü umschalten",

    -- Interact header and binding name
    ["CE Interact"] = "Interagieren",
    ["Interact with Target"] = "Mit Ziel interagieren",
    ...
    ["Clone Current"] = "Aktuelles Profil klonen",
    ["Delete"] = "Löschen",
    ...
    ["Withdraw"] = "Abheben",
    ["Bid"] = "Bieten",
    ["Pickup / Place"] = "Aufheben / Platzieren",
    ["Trade"] = "Handeln",
    ["Toggle"] = "Umschalten",
    ["Loot"] = "Beute",
    ["Send"] = "Senden",
